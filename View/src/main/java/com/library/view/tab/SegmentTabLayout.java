...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_left, SizeUtils.dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_top, 0);
        mIndicatorMarginRight = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_right, SizeUtils.dp2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_divider_width, SizeUtils.dp2px(1));
        mDividerPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_divider_padding, 0);

        mTextSize = ta.getDimension(R.styleable.SegmentTabLayout_tl_textsize, SizeUtils.sp2px(13f));
        ...
        mTabWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_width, SizeUtils.dp2px(-1));
        mTabPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? SizeUtils.dp2px(0) : SizeUtils.dp2px(10));
        ...
        mBarStrokeWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_bar_stroke_width, SizeUtils.dp2px(1));
