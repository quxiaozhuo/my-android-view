...
public class SlidingTabLayout extends HorizontalScrollView {
    private final List<CustomTabModel> mTitles = new ArrayList<>();
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_width, SizeUtils.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_corner_radius, SizeUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_margin_left, SizeUtils.dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_margin_top, SizeUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_margin_right, SizeUtils.dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.MySlidingTabLayout_tl_indicator_margin_bottom, SizeUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.MySlidingTabLayout_tl_underline_height, SizeUtils.dp2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.MySlidingTabLayout_tl_divider_width, SizeUtils.dp2px(0));
        mDividerPadding = ta.getDimension(R.styleable.MySlidingTabLayout_tl_divider_padding, SizeUtils.dp2px(12));

        mTextSize = ta.getDimension(R.styleable.MySlidingTabLayout_tl_textsize, SizeUtils.sp2px(14));
        ...
        mTabWidth = ta.getDimension(R.styleable.MySlidingTabLayout_tl_tab_width, SizeUtils.dp2px(-1));
        mTabPadding = ta.getDimension(R.styleable.MySlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? SizeUtils.dp2px(0) : SizeUtils.dp2px(20));
    ...
    private void addTab(final int position) {
        CustomTabModel title = mTitles.get(position);
        View tabView = View.inflate(getContext(), R.layout.layout_tab, null);
        TextView tv_tab_title = tabView.findViewById(R.id.tv_tab_title);
        if (tv_tab_title != null) {
            if (title != null) tv_tab_title.setText(title.getTabTitle());
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setNewTabs(List<CustomTabModel> titles) {
        if (titles == null) {
            return;
        }
        mTitles.clear();
