...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float radius = a.getDimension(R.styleable.RoundCorner_rRadius, 0);
        float radiusLeft = a.getDimension(R.styleable.RoundCorner_rLeftRadius, radius);
        float radiusRight = a.getDimension(R.styleable.RoundCorner_rRightRadius, radius);
        float radiusTop = a.getDimension(R.styleable.RoundCorner_rTopRadius, radius);
        float radiusBottom = a.getDimension(R.styleable.RoundCorner_rBottomRadius, radius);

        mLeftTopCornerRadius = a.getDimension(R.styleable.CircleImageView_rTopLeftRadius, radiusTop > 0 ? radiusTop : radiusLeft);
        mRightTopCornerRadius = a.getDimension(R.styleable.CircleImageView_rTopRightRadius, radiusTop > 0 ? radiusTop : radiusRight);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.CircleImageView_rBottomLeftRadius, radiusBottom > 0 ? radiusBottom : radiusLeft);
        mRightBottomCornerRadius = a.getDimension(R.styleable.CircleImageView_rBottomRightRadius, radiusBottom > 0 ? radiusBottom : radiusRight);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_rStrokeWidth, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a.getColor(R.styleable.CircleImageView_rStrokeColor, Color.WHITE);
    ...
    public void setBorderColor(int colors) {
        mBorderColor = colors;
        updateDrawable();
        if (mBorderWidth > 0) {
            invalidate();
