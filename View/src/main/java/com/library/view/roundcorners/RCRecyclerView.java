...
public class RCRecyclerView extends androidx.recyclerview.widget.RecyclerView implements RoundMethodInterface {
    ...
    public RCRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RCRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
