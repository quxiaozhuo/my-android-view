package com.library.view.recycler;
...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpacesItemDecoration setParam(@ColorRes int dividerColor, float dividerSpacing) {
     ...
     *                             如果是纵向 - 下边距
     */
    public SpacesItemDecoration setParam(@ColorRes int dividerColor, float dividerSpacing, float leftTopPaddingDp, float rightBottomPaddingDp) {
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setColor(ContextCompat.getColor(mContext, dividerColor));
        mDividerSpacing = SizeUtils.dp2px(dividerSpacing);
        mLeftTopPadding = SizeUtils.dp2px(leftTopPaddingDp);
        mRightBottomPadding = SizeUtils.dp2px(rightBottomPaddingDp);
        mDivider = null;
        return this;
    }
