...
public class HtmlTextView extends JellyBeanSpanFixTextView {
    ...
    public int blockQuoteBackgroundColor = ColorUtils.getColor(android.R.color.white);
    public int blockQuoteStripColor = ColorUtils.getColor(android.R.color.black);
